...
const StickySectionNavCard = <TSection extends NavSection>({
    ...
    const [viewMode, setViewMode] = useState<RailViewMode>('compact');
            ...
            >
                ...
                {isExpanded ? (
                    <div className="relative min-h-0 flex-1 pt-2.5">
                        <div className="max-h-[calc(100vh-17.5rem)] overflow-y-auto pr-1 pb-1 [scrollbar-color:rgba(139,92,246,0.45)_transparent] [scrollbar-width:thin]">
