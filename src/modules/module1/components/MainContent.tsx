    ...
    return (
        <div className="py-8">
            <header className="mb-10 overflow-hidden rounded-[1.5rem] border border-zen-gold/30 bg-[linear-gradient(145deg,rgba(6,11,24,0.94)_0%,rgba(13,22,42,0.9)_60%,rgba(7,14,30,0.94)_100%)] p-6 shadow-[0_24px_55px_rgba(2,6,23,0.42)] backdrop-blur-xl md:p-8">
                <p className="text-xs font-semibold uppercase tracking-[0.36em] text-violet-300">Module Overview</p>
                ...
                <div className="mt-6 grid gap-3 md:grid-cols-3">
                    {overviewPillars.map((pillar) => (
                        <div key={pillar} className="rounded-2xl border border-white/12 bg-white/[0.08] px-4 py-4 backdrop-blur-md">
                            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-cyan-200/90">Focus</p>
